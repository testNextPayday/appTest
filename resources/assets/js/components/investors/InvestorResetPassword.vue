<template>
    ...
    <div>
        ...
        <div class="mr-auto">
            <img class="img-responsive" style="width:6em;" src="/logo_pack/logo/colored/64.png"/>
        </div>
        ...
        <div v-if="page == 1">
            ...
            <br>            
            <form class="form-group" method="POST" @submit.prevent="SendToken">
        
            
                <div class="input-group mb-3">

                    
                    <input type="text" name="phone" class="form-control" required v-model="phone" placeholder="Enter Phone">
         ...
         <div v-if="page == 3">
            ...
            <form class="form-horizontal" method="POST" @submit.prevent="SetPassword">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="Enter New Password" required v-model="password" >
                    
                </div>  

                <div class="input-group mb-3">
                       <!-- <span class="input-group-addon">Confirm</span> -->
                    <input type="password" name="password_confirmation" class="form-control" placeholder="Confirm Password" required v-model="password_confirmation" >
...
export default {
    ...
    methods : {
        ...
        async SetPassword(){
            ...
            await axios.post('/api/v1/npd/investors/password/create', request).then((res) => {

                this.successText  = res.data['message'];

                setTimeout(()=> location.href = 'https://nextpayday.ng/login/lender', 1500);
        ...
        async VerifyToken(){
            ...
            await axios.post('/api/v1/npd/investors/confirm/reset/code', request).then((res) => {
        ...
        async SendToken(){
           ...
           this.ClearMessages();
            ...
            await axios.post('/api/v1/npd/investors/password/reset/code', request).then((res) => {
