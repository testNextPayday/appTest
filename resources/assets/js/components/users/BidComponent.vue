        ...
        <modal v-if="showModal" @close="showModal = false">
            ...
            <div slot="body">
                <div>
                    ...
                    <div class="checkbox">
                        <label for="checkbox1">
                            <input type="checkbox" id="checkbox1" v-model="biddingDifferently"> Offer a different percentage
                        </label>
                    </div>
...
<script>
    export default {
        props: ['loanRequest', 'bidders', 'userId'],
        data() {
            return {
                showModal: false,
                loading: false,
        ...
        methods: {
            confirmIfUserHasBidded() {
                 ...
                 if(user) {
                     ...
                     this.userHasBidded = true;
                       ...
                       this.setInitalBidPercentage();
                 }
            },
            
            setInitalBidPercentage() {
                this.bidPercentage = this.loanRequest.interest_percentage;
            },
            ...
            placeBid() {
                if(this.bidPercentage < 1 || this.bidPercentage > 100) {
                    setError("Bid Percentage must be between than 1 and 100");
                    return;
                }
                ...
                if(shouldProceed) {
                    ...
                    axios.post(`/bids/place`, request).then(response => {
