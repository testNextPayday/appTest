        ...
        <div class="card mx-4">
          <div class="card-body p-4">
            <div class="col-xs-12 col-sm-12 text-center">
              ...
              <br/>
              <h3 class="text-muted strong text-center">STAFF REGISTRATION</h3>
              <p class="text-muted text-center">Complete your registration</p>
            ...
            @if ($errors->any())
              ...
              @endif
            <form class="form-horizontal" method="POST" action="{{ route('staff.invitation.register.submit') }}">
            {{ csrf_field() }}
            ...
            <div class="input-group mb-3">
              ...
              <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required value="{{ $email }}" placeholder="Email" readonly>
            </div>
