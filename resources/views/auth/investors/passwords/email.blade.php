...
<div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
  ...
  <!-- <form method="POST" action="{{ route('investors.passwords.forgot') }}">
    {{ csrf_field() }}
    <div class="mr-auto">
      <img class="img-responsive" style="width:6em;" src="{{asset('logo_pack/logo/colored/64.png')}}"/>
    </div>
    
    <h3 class="mr-auto">Investors: Password Reset</h3>
    <p class="mb-5 mr-auto">Enter your email address below.</p>
  ...
  <investor-reset-password></investor-reset-password>
