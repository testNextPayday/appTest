...
@section('content')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Penalized Loans</h4>
                <div class="row">
                    <div class="col-12 table-responsive">
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                            @foreach($loans->chunk(500) as $loanChunks)
                                    @forelse($loanChunks as $loan)
                                        @php
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">No penalized loans</td>
                                        </tr>
                                    @endforelse
                               @endforeach
                            </tbody>
