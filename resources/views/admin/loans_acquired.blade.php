                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($loan->status == 2)
                                            <div>
                                                <a class="btn btn-xs btn-success" href="{{route('admin.loans.acquired.view', ['id' => encrypt($loan->id)])}}">
                                            ...
                                            <div>
                                                <a class="btn btn-xs btn-info" href="{{route('admin.loans.acquired.view', ['id' => encrypt($loan->id)])}}">
                                            ...
                                            <div>
                                                <a class="btn btn-xs btn-warning"
                                                    href="{{route('admin.loans.acquired.view', ['id' => encrypt($loan->id)])}}">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center">
                                            There are no acquired loans yet
                                        </td>
                                    </tr>
                                    @endif
                                </tbody>
