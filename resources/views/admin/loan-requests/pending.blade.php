    ...
    <div class="content-wrapper">
        <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <h4 class="page-title">Pending Loan Requests</h4>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           @if($loanRequest->status == 0)
                                                <span class="badge badge-danger">Pending Employer <br/> Verification</span>
                                            @elseif($loanRequest->status == 1)
                                                <span class="badge badge-info">Pending Admin<br/>Activation</span>
                                            @elseif($loanRequest->status == 7)
                                            <span class="badge badge-warning" href="#">Loan Request Referred</span>
                                            @else
                                                <span class="badge badge-danger">Unknown</span>
                                            @endif
                                            @if($loanRequest->is_top_up == true)
