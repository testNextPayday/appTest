...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.investors.index')}}">Inactive Investors (Application not done)</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            Inactive Investors (Unfinished Application)
                        ...
                        <div id="dt_example" class="table-responsive card-body">
                            <table class="table table-responsive-sm table-hover table-outline mb-0" id="data-table">
