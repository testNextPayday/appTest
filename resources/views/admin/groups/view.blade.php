...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.group.create')}}">Create Group</a></li>
                                ...
                                <tbody class="col-md-12">
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td class="text-center">
                                         ...
                                         <td class="text-center">
                                            <a href="{{route('admin.group.single-view', ['group' => $group->reference])}}" class="btn btn-sm btn-info"><i class="icon-eye"></i> View</a>
