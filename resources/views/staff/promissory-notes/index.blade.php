                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <a href="{{route('staff.promissory-notes.create')}}" class="btn btn-sm btn-primary">
                        ...
                        <div class="card-body">
                            @component('components.staff_promissory_note_table_list', ['promissoryNotes'=> $promissoryNotes])
                            @endcomponent
                        </div>
                    </div>
                </div>
