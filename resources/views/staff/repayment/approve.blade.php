            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 table-responsive">
                        ...
                        <form action="{{route('staff.approve.all.repayments')}}"  method="post" id="repayment-form">
                            {{csrf_field()}}
                            <input type="hidden" id="repayments-input" name="repayments[]"/>
                            
                        </form>

                        <form action="{{route('staff.delete.all.repayments')}}"  method="post" id="repayment-deletion-form">
                            {{csrf_field()}}
