                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($loan->status == 2)
                                            <div>
                                                <a class="btn btn-xs btn-success" href="{{route('staff.funds.view', ['id' => encrypt($loan->id)])}}">
                                            ...
                                            <div>
                                                <a class="btn btn-xs btn-info" href="{{route('staff.funds.view', ['id' => encrypt($loan->id)])}}">
                                            ...
                                            <div>
                                                <a class="btn btn-xs btn-warning"
                                                    href="{{route('staff.funds.view', ['id' => encrypt($loan->id)])}}">
