...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('staff.funds.index')}}">Loans</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="card-group mb-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @if($loan->status == 5)
                                        <div class="h4 mb-0">₦ {{number_format(App\Models\LoanFund::whereOriginalId($loan->id)->first()->amount, 0)}}</div>
                                        <small class="text-muted text-uppercase font-weight-bold">Transfer Value</small>
                                        @else
                        ...
                        <div class="card-footer text-right">
                            ...
                            <loan-transfer :loan-fund="{{$loan}}" :current-value="{{$currentValue}}" :url="'{{route('staff.funds.transfer')}}'"></loan-transfer>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar">
                                                <img src="{{$bid->investor->avatar}}" class="img-avatar" alt="avatar">
                                                <span class="avatar-status badge-success"></span>
                                             </div>
                                        </td>
                                        <td>
                                            <div>{{$bid->investor->name}}</div>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-primary" 
                                                href="{{route('staff.bids.loans.accept', ['bid_id' => encrypt($bid->id)])}}"
                            ...
                            <table class="table table-responsive-sm table-hover table-outline mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-muted text-center">
                                                @if($loop->iteration === optional($loan->loanRequest)->duration)
                                                0
                                                @else
