...
@section('content')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-menu">
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <a class="btn btn-primary btn-lg waves-effect text-white"
                        href="{{ route('users.loan-requests.create') }}" style="border-radius: 20px;">
                            ...
                            <div class="card-header">
                                ...
                                <span class="pull-right">
                                    <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                        data-target="#withdrawalRequestModal">New Request</button>
                                </span>
                            </div>
                            <div class="card-body">
        ...
        <div class="modal fade" id="withdrawalRequestModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
