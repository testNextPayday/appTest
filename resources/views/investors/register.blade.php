    ...
    <section class="register">
      ...
      <div id="reg_con" class="container">
        <div class="form_block">
          <h2 class="form_title">Signup as Investor</h2>

          <p>
            Have an Account?
            <a href="{{route('investors.signin')}}">
              <span class="reg_sub-t">Login Here </span>
            </a>
          </p>

          <form method="post" action="{{route('investors.send.otp')}}">
              @csrf
            <div class="form-group mt-5">
                ...
                <p v-if="field.errors.length > 0" class="text-error text-sm">
            ...
            <div class="actions">
                ...
                <!-- <a href="./otp.html" class="confirm_btn form_btn"> Submit </a> -->
            </div>
         </form>
        </div>
      </div>
