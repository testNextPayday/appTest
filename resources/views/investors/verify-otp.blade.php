    ...
    <section class="register">
      <div style="display: none" class="checking">
        <div class="checking_block">
          <img class="checking_icon" src="{{asset('investorpage/assets/usericon.png')}}" />
          <p>verifying ...</p>
        </div>
      </div>
      <div id="reg_con" class="container">
        <div class="form_block">
          <h2 class="form_title">OTP Verification</h2>

          <p>
            Enter The OTP Sent to Your Phone
          </p>

          <form method="post" action="{{route('investors.verify.otp')}}">
              @csrf
