...
<div class="content-wrapper">
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <h4 class="page-title">Acquired Funds</h4>
        </div>
    </div>
            ...
            <div class="card support-pane-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title mb-0">Acquired Funds</h4>
                    </div>
                    <div class="table-responsive support-pane no-wrap">
                        ...
                        <div class="t-row">
                            ...
                            <div class="content">
                                <p class="font-weight-bold mb-2 d-inline-block">{{ $request->user->reference }}</p>
                                <p class="text-muted mb-2 d-inline-block">{{ $fund->created_at->format('Y-m-d') }}</p>
                                <p>
                                  Loan duration is <strong>{{ $request->duration }} {{str_plural('month', $request->duration)}}</strong>
                                  &nbsp;
                                  @if($fund->status == 1)
                            ...
                            <div class="tile">
                                ...
                                <p class="font-weight-bold">{{ strtoupper($request->reference) }}</p>
                            </div>
                            <div class="tile">
                                <p class="text-muted mb-2">Purchase Amount</p>
