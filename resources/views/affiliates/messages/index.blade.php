            ...
            <div class="card">
                <div class="card-body">
                    @forelse($conversations as $conversation)
                        ...
                        <?php
                            if ($conversation->participant instanceof App\Models\Admin) {
                                $route =  route('affiliates.messages.show', ['entityCode' => '001', 'entityId' => $conversation->participant->id]);
                            } else {
                                $route = "#";
                            }
                        ?>
                            ...
                            <div class="wrapper ml-3">
                                <h6 class="mb-1">
                                    <a href="{{ $route }}" class="text-info">
                                        {{ ($conversation->participant instanceof App\Models\Admin) ? 'Nextpayday ADMIN' : $conversation->participant->name }}
                                    </a>
                                </h6>
                    ...
                    @empty
                        <div class="wrapper d-flex align-items-center py-2 border-bottom">
                            ...
                            <div class="wrapper ml-3">
                                ...
                                <a href="{{ route('affiliates.messages.show', ['entityCode' => '001', 'entityId' => optional(\App\Models\Admin::first())->id])}}"
