...
class PayMonthlyBills extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'monthly:bills';
     ...
     * @var string
     */
    protected $description = 'Pays all the automated monthly bills';
