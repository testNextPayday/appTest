...
class LoanPeakSweeper extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sweep_peak:loans';
     ...
     * @var string
     */
    protected $description = 'Checks all due collections (by peak sweep periods) and hands them over for sweeping';
    ...
    {
        $loans = Utilities::getLoansForPeakSweep();
        $sweeper = new Sweeper();
        $sweeper->sweep($loans);
    }
}
