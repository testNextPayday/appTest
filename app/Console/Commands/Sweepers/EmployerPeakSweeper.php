...
class EmployerPeakSweeper extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sweep_peak:employers';
     ...
     * @var string
     */
    protected $description = 'Checks all due collections (by employers peak periods) and hands them over for sweeping';
    ...
    {
        $employers = Utilities::getEmployersForPeakSweep();
