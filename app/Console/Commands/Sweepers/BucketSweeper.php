 ...
 */
class BucketSweeper extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sweep:buckets';
     ...
     * @var string
     */
    protected $description = 'Checks all due collections (by buckets) and hands them over for sweeping';
    ...
    {
        $buckets = Utilities::getBucketsForSweep();
