...
class WithdrawalRequestController extends Controller
{
    ...
    public function pending()
    {
        ...
        return view('staff.withdrawals.index', compact('withdrawalRequests', 'title'));
    }
    ...
    public function all()
    {
        ...
        return view('staff.withdrawals.index', compact('withdrawalRequests'));
    }
    ...
    public function show(Request $request, WithdrawalRequest $withdrawal)
    {
        ...
        return view('staff.withdrawals.show', $payload);
    }
}
